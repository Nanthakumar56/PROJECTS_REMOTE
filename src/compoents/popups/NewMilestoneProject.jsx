...
const NewMilestoneProject = ({ onClose, milestoneData, setMilestoneData }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    const newMilestoneData = {
      ...
      start_date: formValues.startDate
        ? formatToLocalDateTime(formValues.startDate)
        : null,
      target_date: formValues.targetDate
        ? formatToLocalDateTime(formValues.targetDate)
        : null,

      status: formValues.status,
      step: formValues.steps ? parseInt(formValues.steps) : 0,
      reason: formValues.reason,
    };

    setMilestoneData((prev) => [...prev, newMilestoneData]);
    onClose();
  };
    ...
    >
      <div className="bg-white rounded-lg p-4 w-[340px] lg:w-[420px] xl:w-[500px]">
        ...
        <form className="px-1 lg:px-2">
          ...
          <div className="flex flex-wrap items-center gap-4 mb-1.5 lg:mb-2 xl:mb-3">
...
export default NewMilestoneProject;
